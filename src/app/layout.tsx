...
export const metadata: Metadata = {
  title: "Myka - Yogurt Griego Artesanal en Madrid",
  description: "Descubre el auténtico yogurt griego artesanal de Myka en Madrid. Elaborado con recetas tradicionales y ingredientes naturales de primera calidad.",
  keywords: "yogurt griego, Madrid, artesanal, griego, natural, probióticos, tradicional, Myka",
  metadataBase: new URL("https://myka-yogurt.com"),
  alternates: {
    canonical: "https://myka-yogurt.com"
  },
  openGraph: {
    title: "Myka - El Auténtico Yogurt Griego de Madrid",
    description: "Yogurt griego artesanal elaborado con recetas tradicionales en el corazón de Madrid",
    url: "https://myka-yogurt.com",
    siteName: "Myka Greek Yogurt",
    images: [{
      url: "https://images.pexels.com/photos/8743829/pexels-photo-8743829.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Yogurt griego Myka con frutos del bosque"
    }],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Myka - Yogurt Griego Artesanal Madrid",
    description: "El auténtico sabor del yogurt griego tradicional en Madrid",
    images: ["https://images.pexels.com/photos/8743829/pexels-photo-8743829.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
